    ...
    <section>
        <div className='max-w-7xl mx-auto px-4 mt-20'>
            <div className='text-center mb-12 border-t border-neutral-800'>
                <h2 className='text-3xl lg:text-5xl mt-20 tracing-tighter bg-gradient-to-t from-neutral-50 via-neutral-300 to-neutral-600 bg-clip-text text-transparent'>
            ...
            className='flex flex-wrap justify-between '>
                    {KEY_FEATURES_CONTENT.features.map((feature)=> (
                        <motion.div key={feature.id} className='flex flex-col items-center text-center w-full md:w-1/2 lg:w-1/3 p-6' variants = {featureVariants}>
